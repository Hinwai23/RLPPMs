...
def make_train_env():
    return MaskedEnvWrapper(ELEnv(train_transitions, activity2idx, use_true_end_reward=True, reward_scale=0.001))

def make_eval_env():
    return MaskedEnvWrapper(ELEnv(all_transitions, activity2idx, use_true_end_reward=True, reward_scale=0.001))
