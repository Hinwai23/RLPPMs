...
class DQNEvaluator:
    def __init__(self, model_path='dqn_el_best.pth'):
        """
        Initialize the DQN evaluator for EL
        """
    ...
    def _load_model(self):
        """Load the trained DQN model - EL version"""
...
def main():
    ...
    """
    print("Initializing DQN evaluator...")
    
    # Initialize evaluator with the saved model
    evaluator = DQNEvaluator('dqn_el_best.pth')
